...
//         adImg.src = 'http://usfa.gov.ua:8080/frontend/web/upload/media/2018/02/01/5a72cb0a082e7-7553-1451392486-teper.jpg';
...
//         // closeButton.addEventListener('click', function() {ad.remove();});
//         // ad.appendChild(closeButton);
//         // document.body.appendChild(ad);
//     }
  
//     setTimeout(function(){showAd()},1500);
//     let cb = document.getElementById("adv");
//     cb.innerText = '2';
//     // setTimeout(function(){},1000);
//     // closeButton.innerHTML = '2';
//     // // ad.appendChild(closeButton);
//     // // document.body.appendChild(ad);
//     // setTimeout(function(){},1000);
//     // closeButton.innerHTML = '1'
//     // // ad.appendChild(closeButton);
//     // // document.body.appendChild(ad);
//     // setTimeout(function(){closeAd()},1000);
